...
const experiences = [
  {
    ...
    points: [
      ...
      "Configured and managed DNS and DHCP services using RSAT, utilizing subnetting and ensuring high availability.",
      "Deployed and managed scripts on auto-scaling AWS EC2 instances with custom AMIs and optimized EBS storage, as well as local servers, using PowerShell, ConnectWise, and SSH, enhancing park-wide productivity.",
      "Managed Layer 2/3 switches through CLI (Cisco, Aruba, Ubiquiti), utilizing SDN and EVPN for advanced network segmentation and traffic optimization, significantly improving network availability and performance.",
      "Integrated SMB file shares with ACL enforcement, configured Print Server roles, and streamlined deployments within the Azure environment.",
  ...
  },
  {
    ...
    points: [
      ...
      "Orchestrated CI/CD pipelines for IT infrastructure maintenance using GitLab CI, optimizing workflows for Citrix, VMware, VDI, Hyper-V, ESXi.",
      "Automated update processes with Bash/YAML scripts and conducted audits, ensuring stability and security of bedside applications.",
