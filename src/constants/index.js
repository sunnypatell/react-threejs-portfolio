...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Performed L2 hospital-wide management of 300+ bedside iPads efficiently with JamF (Apple MDM Profiling).",
      "Optimized entertainment app load times by over 25%*, providing IPTV, VOIP, movies, games, and meal ordering.",
      "Contributed to software development and maintenance using Java, Python, and SQL.",
      "CI/CD on system maintenance for IT infrastructure, spanning Citrix, VMware, VDI, Hyper-V, ESXi technologies.",
      "Scripted CLI scripting for system services resolution and comprehensive audits for bedside application code pushes.",
      "Leveraged Cortex XDR for monitoring network traffic and detecting malicious malware activity.",
    ],
  },
  {
