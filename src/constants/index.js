...
const experiences = [
  ...
  },
  {
    ...
    points: [
      "Supported 300+ bedside iPads efficiently with JamF (Apple MDM Profiling).",
      "Optimized entertainment app load times by over 25%*, providing IPTV service, VOIP, movie service, games, and meal ordering.",
